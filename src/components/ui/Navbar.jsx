...
export default function Navbar({ isDayMode, scrollToSection }) {
        ...
        <>
            ...
            <motion.nav
                ...
                style={{
                    ...
                    boxShadow: '0 4px 30px rgba(0,0,0,0.3), 0 0 60px rgba(0, 212, 255, 0.03)',
                ...
                <div className="flex md:hidden items-center gap-2">
                    ...
                    >
                        <motion.span
                            ...
                            style={{ width: '18px', height: '2px', background: 'var(--color-text-primary)', display: 'block', borderRadius: '2px' }}
                        />
                        <motion.span
